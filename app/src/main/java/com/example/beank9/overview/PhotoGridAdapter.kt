...
import com.example.beank9.databinding.GridViewItemBinding
...
class PhotoGridAdapter :
    ListAdapter<FeedPhoto, PhotoGridAdapter.FeedPhotosViewHolder>(DiffCallback) {

    /**
     * The MarsPhotosViewHolder constructor takes the binding variable from the associated
     * GridViewItem, which nicely gives it access to the full [MarsPhoto] information.
     */
    class FeedPhotosViewHolder(
        private var binding: GridViewItemBinding
    ) : RecyclerView.ViewHolder(binding.root) {
        fun bind(feedPhoto: FeedPhoto) {
            binding.photo = feedPhoto
     ...
     */
    companion object DiffCallback : DiffUtil.ItemCallback<FeedPhoto>() {
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): FeedPhotosViewHolder {
        return FeedPhotosViewHolder(
