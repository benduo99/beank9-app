...
import com.example.beank9.overview.PhotoApiStatus
import com.example.beank9.overview.PhotoGridAdapter

/**
 * Updates the data shown in the [RecyclerView].
 */
@BindingAdapter("listData")
fun bindRecyclerView(recyclerView: RecyclerView, data: List<FeedPhoto>?) {
